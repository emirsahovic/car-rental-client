  ...
  return (
    <Box
      ...
      sx={{
        pb: "4.2rem",
        mb: "3rem",
        ml: { xs: "16%", sm: "13%", md: "4.6rem" },
        width: { xs: "17rem", sm: "18.5rem", md: "22.5rem" },
        height: { xs: "29rem", sm: "28.5rem", md: "24.5rem" },
        backgroundColor: "#fff",
        borderRadius: "10px",
    ...
    >
      ...
      <Box sx={{ pl: "1rem", pr: "3rem", pt: "1rem" }}>
        ...
        >
          <Stack direction='row' spacing={1}>
            ...
            <Typography sx={{ fontSize: "14px", color: "#777" }}>
              {car.numberOfSeats} People
            </Typography>
          </Stack>
          <Stack
            direction='row'
            spacing={1}
            marginTop={{ xs: "0.6rem", md: "0" }}
          >
        ...
        >
          ...
          <Stack
            ...
            spacing={1}
            marginRight={`${
              car.transmission === "Manual" ? "0.52rem" : "1.7rem"
            }`}
            marginTop={{ xs: "0.6rem", md: "0" }}
          >
      ...
      <Stack
        ...
        sx={{ pl: "1rem", pr: "1.2rem", pt: "1.7rem" }}
      >
        <Typography sx={{ fontSize: "28px", color: "#444", fontWeight: "500" }}>
          {car.price}KM
          <Typography sx={{ fontSize: "20px", color: "#555" }} component='span'>
            /d
          </Typography>
        </Typography>
        <Link to={`/vehicle/${car._id}`} className='btn-opacity'>
          ...
          >
            <Typography sx={{ fontSize: "18px", color: "#fe5b3e" }}>
              View More
            </Typography>
